...
@Component({
  selector: 'app-grafica-ventas-hora',
  templateUrl: './grafica-ventas-hora.component.html',
  styleUrls: ['./grafica-ventas-hora.component.scss']
})
export class GraficaVentasHoraComponent {
  ...
  pintarGrafica(data: any)  {
    ...
    var chartDom = document.getElementById('ventas-hora')!;
